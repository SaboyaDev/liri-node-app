...
var command = {
  ...
  OMDB_Resp: function (response) {
    ...
    command.OMDB_Disp(title, year, IMDB_Rating, RT_Rating, country, language, plot, actors);
  },
  alpha_Vantage_Resp: function (response) {
    ...
    command.alpha_Vantage_Disp(title, last_Refresh, time_Zone, symbol, open, high, low, close);
  },
  ...
  OMDB_Disp: function (title, year, IMDB_Rating, RT_Rating, country, language, plot, actors) {
  ...
  alpha_Vantage_Disp: function (title, last_Refresh, time_Zone, symbol, open, high, low, close) {
    // Display the Results
    console.log(
...
if (typeof command[process.argv[2]] === "function") {
  ...
  if (process.argv[2] !== "spotify_this_song" && process.argv[2] !== "do_what_it_says") {
